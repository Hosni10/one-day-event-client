        ...
        <div className="border-t border-gray-200 pt-8">
          ...
          <div className="mt-6">
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-start space-x-3 space-y-0 p-4 border border-gray-200 rounded-lg bg-blue-50">
                  <FormControl>
                    <Checkbox
                      checked={field.value}
                  ...
                  <div className="space-y-1 leading-none">
                    <FormLabel className="text-sm">
                      I confirm that I am physically fit to participate in sports activities and have consulted with my doctor if I have any concerns about my health or ability to participate safely. *
                    </FormLabel>
                  </div>
                  <FormMessage />
                </FormItem>
